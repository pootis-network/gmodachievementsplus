...
AchievementsPlus:AddEventHook ("AchievementsPlusLoaded", "AchievementsWindow.Create", function ()
	...
	function AchievementsPlus.AchievementsPanel:CreateControls ()
		...
		for k = 0, #items - 1 do
			...
			if !material or string.len (material) == 0 then
				material = ""
			end
...
function AchievementsPlus.AchievementsPlusPanel (Panel)
	Panel:ClearControls ()
	Panel:AddControl ("Label", {Text = "Achievements Plus - !cake"})
	Panel:AddControl ("Button", {Text = "Show Achievements", Label = "Open Achievements List", Command = "achievements_show"})
	Panel:AddControl ("Button", {Text = "Reset Achievements", Label = "Reset All Achievements", Command = "achievements_reset"})
end
